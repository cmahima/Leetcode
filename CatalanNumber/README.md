Applications :
Source [Geeks for geeks](https://www.geeksforgeeks.org/applications-of-catalan-numbers/)
...
- The number of paths with 2n steps on a rectangular grid from bottom left, i.e., (n-1, 0) to top right (0, n-1) that do not cross above the main diagonal rectangle
